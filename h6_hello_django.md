...
*(Lisäys 27.9. 21.26: Koska käytin samaa projektia samalla koneella, minun olisi kannattanut käyttää jo olemassaolevaa virtuaaliympäristöä. Jostain myös luin/näin videolta, että yleensä käytetään ympäristön nimenä env tai venv eikä aleta nimeämään niitä miksi sattuu. Myös mikalie-kansio aiheutti ylimääräistä säätämistä myöhemmin. Sen sijaan ohjeessa oli olennaisia kohtia, joista hyppäsin yli, kuten myöhemmin raportista voi nähdä.)*
