...
Tässä kohtaa saan todeta hypänneeni liian nopsaan alun yli. Tiesin aiempien viikkojen ongelmanselvittelyjen pohjalta, että näkyvissä oli var-kansion default-sivu, jonne päädytään helposti esimerkiksi silloin, kun conf-tiedostossa on jotain häikkää:
